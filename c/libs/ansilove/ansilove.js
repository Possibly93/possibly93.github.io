var AnsiLove = (function () {
    ...
    function displayDataToCanvas(displayData) {
        // fix to ignore buggy .ans files
        //console.log(displayData.height)
        if (displayData.height!=0) {
            ...
            ctx.fillText("Nope.", canvas.width/2, canvas.height/2+5); 
        }
        return canvas;
    }
