...
if (!supports_html5_storage()) {
	console.log('HTML5 storage is not supported in this browser.');
}
		...
		if (box) {
			...
			if (!curpoints) {
				if (iteration > 0) {
					...
					converged = true;
					console.log("Having some problems converging on a face in this image. Using the best estimate.");
					break;
				} else {
					console.log("Having some problems converging on a face in this image. Please try again.");
					return false;
				}
			}
		} else {
