        ...
        if (keyCommands.length > 0) {
            ...
            switch (keyCmd) {
                ...
                case 0x0D:
                    ...
                    dataOut.push(Math.floor((mouseX / outputEl.outerWidth * mouseXmax) >> 8));
                    dataOut.push(Math.floor((mouseX / outputEl.outerWidth * mouseXmax) & 0xff));
                    dataOut.push(Math.floor((mouseY / outputEl.outerHeight * mouseYmax) >> 8));
                    dataOut.push(Math.floor((mouseY / outputEl.outerHeight * mouseYmax) & 0xff));
