...
function run() {
	if (GameBoyEmulatorInitialized()) {
		if (!GameBoyEmulatorPlaying()) {
			...
			if(gameboy.name=='METROID2')    {gameboy.colors=[0Xaedf1e,0Xb62558,0X047e60,0X2c1700]}
			if(gameboy.name=='POKEMON GRE') {gameboy.colors=[0Xacb56b,0X768448,0X3f503f,0X181010]}
			if(gameboy.name=='POKEMON RED') {gameboy.colors=[0Xffefff,0Xff9999,0X84739c,0X181010]}
			if(gameboy.name=='POKEMON BLU') {gameboy.colors=[0Xffefff,0X99cccc,0X84739c,0X181010]}
			if(gameboy.name=='POKEMON YEL') {gameboy.colors=[0Xffffef,0Xcccc66,0X996633,0X181010]}
